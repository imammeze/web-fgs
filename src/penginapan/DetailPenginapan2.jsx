    ...
    <>
      ...
      <div className="py-16 px-16">
        <div className="flex justify-between mt-16">
          <div className="flex flex-col">
            ...
            <div className="flex gap-10 flex-col mt-10">
              <div>
                <h1 className="text-3xl font-bold">Khaira Homestay</h1>
                <div className="flex gap-2 items-center mt-2">
                  <img src="/img/icon-lokasi.svg" />
                  <p>Desa Serang Rt 04 Rw 04 Kec. Karangreja, Purbalingga</p>
                </div>
              </div>
              <div>
                <h1 className="text-3xl font-bold">Deskripsi Penginapan</h1>
                <p className="text-sm text-justify mt-2">
                  Khaira Homestay adalah akomodasi yang sempurna untuk Anda yang
                  mencari suasana ramah dan nyaman seperti di rumah sendiri
          ...
          <div>
            <div className="flex justify-center gap-6 w-[600px] flex-wrap">
              <img
                src="/img/penginapan2/2.jpeg"
                className="w-[250px] h-[240px] rounded-3xl  shadow-md"
              />
              <img
                src="/img/penginapan2/3.jpeg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
              <img
                src="/img/penginapan2/4.jpeg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
              <img
                src="/img/penginapan2/5.jpeg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
            </div>
        ...
        <div className="mt-16 mx-auto">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.0550010540446!2d109.28370167404053!3d-7.234567171049265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6ff1758baf9217%3A0xf22ed66b851c446b!2sHomeStay%20Khaira%20Serang!5e0!3m2!1sid!2sid!4v1719475487526!5m2!1sid!2sid"
            width="1200"
            height="600"
...
export default DetailPenginapan2;
