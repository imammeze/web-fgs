    ...
    <>
      ...
      <div className="py-16 px-16">
        <div className="flex justify-between mt-16">
          <div className="flex flex-col">
            ...
            <div className="flex gap-10 flex-col mt-10">
              <div>
                <h1 className="text-3xl font-bold">Wisma Griyaku</h1>
              ...
              <div>
                ...
                <p className="text-sm text-justify mt-2">
                  Wisma Griyaku adalah akomodasi yang sempurna untuk Anda yang
          ...
          <div>
            <div className="flex justify-center gap-6 w-[600px] flex-wrap">
              <img
                src="/img/penginapan5/2.png"
                className="w-[250px] h-[240px] rounded-3xl  shadow-md"
              />
              <img
                src="/img/penginapan5/3.jpg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
              <img
                src="/img/penginapan5/4.jpg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
              <img
                src="/img/penginapan5/5.jpg"
                className="w-[250px] h-[240px] rounded-3xl shadow-md"
              />
            </div>
            <div className="flex flex-col gap-4 items-center px-4 py-4 w-[400px] mt-10 mx-auto border border-black rounded-2xl shadow-xl">
              ...
              <p className="font-bold text-4xl text-center">Rp 500.000,-</p>
              <p className="text-center">/ Malam</p>
              <Link
                to="/https://wa.me/+6285700736754"
        ...
        <div className="mt-16 mx-auto">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.997337937954!2d109.28338056986257!3d-7.2411397551063335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6ff1822f730ab1%3A0xc97c2e859238fa1!2sWisma%20Griyaku%20Serang!5e0!3m2!1sid!2sid!4v1719476159363!5m2!1sid!2sid"
            width="1200"
            height="600"
...
export default DetailPenginapan5;
